            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-surface p-8 rounded-lg border border-border">
                <div className="flex items-center space-x-3 mb-6">
                  <div className="relative h-12 w-12 rounded-full p-[2px] bg-instagram-gradient overflow-hidden group">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-accent-primary mt-0.5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <a href="mailto:hello@webbies.dev" className="text-accent-primary hover:underline flex items-center">
                      hello@webbies.dev
                    </a>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <span className="text-foreground-secondary">webbies.dev</span>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
              <div className="md:col-span-1">
                <div className="bg-surface p-4 rounded-lg border border-border mb-6">
                  <div className="relative aspect-square rounded-lg bg-instagram-gradient mb-4 overflow-hidden group">
                    <div className="absolute inset-0 bg-instagram-gradient opacity-75 group-hover:opacity-100 transition-opacity"></div>
                  ...
                  <h3 className="text-xl font-bold">Webbies</h3>
